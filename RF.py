...
def random_forest(x, y):
    ...
    print(r2)
    print(rmse)
    utils.table_creation(['Number of trees', 'R^2', 'RMSE', 'MAE'], [n_trees, r2, rmse, mae],
                         'rf_table.txt')
